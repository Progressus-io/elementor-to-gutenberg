<?php
/**
 * Plugin Name: Mighty Kids
 * Plugin URI: https://mightykidssupplements.co.uk/
 * Description: Mighty Kids plugin.
 * Author: Progressus
 * Author URI: https://progressus.io/
 * Version: 1.0.0
 * Text Domain: mighty-kids
 *
...
namespace Progressus\MightyKids;
...
require_once plugin_dir_path( __FILE__ ) . '/src/class-adminsettings.php';
