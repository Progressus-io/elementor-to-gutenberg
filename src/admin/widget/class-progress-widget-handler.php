...
class Progress_Widget_Handler implements Widget_Handler_Interface {
	...
	public function handle( array $element ): string {
		...
		return sprintf(
			'<!-- wp:blockshift/progress %s --><div class="wp-block-blockshift-progress"%s><div class="blockshift-progress-bar" style="text-align:left">%s<div class="blockshift-progress-bar-container"%s><div class="blockshift-progress-bar-fill"%s><div %s>%s<span class="blockshift-progress-percentage">%s</span></div></div></div></div></div><!-- /wp:blockshift/progress -->',
