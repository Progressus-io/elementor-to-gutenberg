...
class Addons_Page {
	...
	public function register_menu(): void {
		add_submenu_page(
			'blockshift-settings',
			esc_html__( 'Add-ons', 'blockshift-migrate-from-elementor' ),
			esc_html__( 'Add-ons', 'blockshift-migrate-from-elementor' ),
			'manage_options',
			self::MENU_SLUG,
		...
		<div class="pgs-screen" data-screen-label="Add-ons">
			...
			<div class="pgs-col">
				<div class="pgs-pagetitle">
					<div>
						<h1><?php esc_html_e( 'Add-ons', 'blockshift-migrate-from-elementor' ); ?></h1>
						<p><?php esc_html_e( 'Extend BlockShift with optional add-ons. Add-ons are separate plugins hosted on block-shift.com.', 'blockshift-migrate-from-elementor' ); ?></p>
					</div>
				</div>
				...
				<div class="pgs-stack" style="gap:var(--gap-section);">
					...
					<div class="pgs-card">
						<div class="pgs-card__header">
							<div>
								<div class="pgs-card__eyebrow"><?php esc_html_e( 'Add-on', 'blockshift-migrate-from-elementor' ); ?></div>
								<div class="pgs-card__title"><?php esc_html_e( 'BlockShift AI Enhancement', 'blockshift-migrate-from-elementor' ); ?></div>
							</div>
						</div>
						<div class="pgs-card__body">
							<p style="margin-top:0;">
								<?php esc_html_e( 'AI-powered design enhancement that uses your own Anthropic (Claude) API key to nudge converted pages closer to the original Elementor design.', 'blockshift-migrate-from-elementor' ); ?>
							</p>

							<ul class="pgs-featurelist">
								<li><span class="pgs-featurelist__icon"><i data-icon="check"></i></span><?php esc_html_e( 'Refines spacing, alignment, and typography after conversion', 'blockshift-migrate-from-elementor' ); ?></li>
								<li><span class="pgs-featurelist__icon"><i data-icon="check"></i></span><?php esc_html_e( 'Uses your own Claude API key — you stay in control of usage and cost', 'blockshift-migrate-from-elementor' ); ?></li>
								<li><span class="pgs-featurelist__icon"><i data-icon="check"></i></span><?php esc_html_e( 'Installs alongside BlockShift as a separate add-on plugin', 'blockshift-migrate-from-elementor' ); ?></li>
							</ul>
							...
							<div class="pgs-actions-end">
								<a class="pgs-btn pgs-btn--primary pgs-btn--md" href="<?php echo esc_url( self::AI_ADDON_URL ); ?>" target="_blank" rel="noopener noreferrer">
									<span><?php esc_html_e( 'Get the AI Enhancement add-on', 'blockshift-migrate-from-elementor' ); ?></span>
