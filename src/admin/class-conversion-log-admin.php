				...
				<div class="pgs-card">
					...
					<div class="pgs-card__body">
						<p class="pgs-muted" style="margin-bottom:12px;">
							<?php esc_html_e( 'Structured machine-readable log. Every conversion run appends JSON events — one per line. Attach this file to a feedback report or import it into the Feedback Hub for AI analysis.', 'migrate-off-elementor' ); ?>
						</p>
						...
						<?php if ( $jsonl_log_exists && ! empty( $jsonl_log_lines ) ) : ?>
							<div class="pgs-code">
								<div class="pgs-code__bar">
									...
									<button type="button" class="pgs-code__copy" id="metg-jsonl-copy"><i data-icon="copy"></i><span><?php esc_html_e( 'Copy', 'migrate-off-elementor' ); ?></span></button>
								</div>
