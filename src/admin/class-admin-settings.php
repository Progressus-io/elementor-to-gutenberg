                    ...
                    <div class="pgs-stack" style="gap:var(--gap-section);">
                            ...
                            <div class="pgs-card__body">
                                <div class="pgs-setrow">
                                    <div class="pgs-setrow__meta">
                                        <label class="pgs-setrow__label" for="metg_section_content_width"><?php esc_html_e( 'Section content width', 'layoutbridge-block-migration' ); ?></label>
                        ...
                        <div class="pgs-card">
                            ...
                            <div class="pgs-card__body">
                                <div class="pgs-setrow">
                                    <div class="pgs-setrow__meta">
                                        <label class="pgs-setrow__label" for="metg_claude_api_key"><?php esc_html_e( 'Claude API Key', 'layoutbridge-block-migration' ); ?></label>
                                        <div class="pgs-setrow__desc">
