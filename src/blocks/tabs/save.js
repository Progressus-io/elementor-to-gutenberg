...
const Save = ( { attributes } ) => {
	...
	const tabHeaderStyle = {
		...
		borderColor,
		color: tabTextColor,
		padding: `${ tabsPadding?.top || 12 }px ${
			tabsPadding?.right || 16
		}px ${ tabsPadding?.bottom || 12 }px ${ tabsPadding?.left || 16 }px`,
	...
	const contentStyle = {
		...
		padding: `${ contentPadding?.top || 20 }px ${
			contentPadding?.right || 20
		}px ${ contentPadding?.bottom || 20 }px ${
