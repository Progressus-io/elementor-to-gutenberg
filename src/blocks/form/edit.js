...
const Edit = ( { attributes, setAttributes } ) => {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Form Settings', 'layoutbridge-block-migration' ) }
					initialOpen={ true }
				>
					<TextControl
						label={ __( 'Form Name', 'layoutbridge-block-migration' ) }
						value={ formName }
						onChange={ ( value ) =>
					...
					/>
					<SelectControl
						label={ __( 'Input Size', 'layoutbridge-block-migration' ) }
						value={ inputSize }
						options={ [
							{
								label: __( 'Small', 'layoutbridge-block-migration' ),
								value: 'sm',
							},
							{
								label: __( 'Medium', 'layoutbridge-block-migration' ),
								value: 'md',
							},
							{
								label: __( 'Large', 'layoutbridge-block-migration' ),
								value: 'lg',
							},
						] }
						onChange={ ( value ) =>
					...
					/>
					<RangeControl
						label={ __( 'Column Gap', 'layoutbridge-block-migration' ) }
						value={ columnGap }
						onChange={ ( value ) =>
					...
					/>
					<RangeControl
						label={ __( 'Row Gap', 'layoutbridge-block-migration' ) }
						value={ rowGap }
						onChange={ ( value ) =>
				...
				<PanelBody
					title={ __( 'Label Style', 'layoutbridge-block-migration' ) }
					initialOpen={ false }
				>
					<RangeControl
						label={ __( 'Label Spacing', 'layoutbridge-block-migration' ) }
						value={ labelSpacing }
						onChange={ ( value ) =>
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Normal', 'layoutbridge-block-migration' ),
								value: 'normal',
							},
							{
				...
				<PanelBody
					title={ __( 'Button Style', 'layoutbridge-block-migration' ) }
					initialOpen={ false }
				>
					<TextControl
						label={ __( 'Button Text', 'layoutbridge-block-migration' ) }
						value={ buttonText }
						onChange={ ( value ) =>
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Start', 'layoutbridge-block-migration' ),
								value: 'start',
							},
							{
							...
							{
								label: __( 'End', 'layoutbridge-block-migration' ),
								value: 'end',
							},
						] }
						onChange={ ( value ) =>
					...
					/>
					<TextControl
						label={ __( 'Text Color', 'layoutbridge-block-migration' ) }
				...
				<PanelBody
					title={ __( 'Messages', 'layoutbridge-block-migration' ) }
					initialOpen={ false }
				>
					<TextControl
						label={ __(
					...
					/>
					<TextControl
						label={ __( 'Error Message', 'layoutbridge-block-migration' ) }
						value={ errorMessage }
						onChange={ ( value ) =>
				...
				<PanelBody
					title={ __( 'Form Fields', 'layoutbridge-block-migration' ) }
					initialOpen={ true }
				>
					...
					<Button
						...
						style={ { width: '100%' } }
					>
						{ __( 'Add Field', 'layoutbridge-block-migration' ) }
					</Button>
				</PanelBody>

				{ formFields[ editingField ] && (
					<PanelBody
						title={ __( 'Edit Field', 'layoutbridge-block-migration' ) }
						initialOpen={ true }
					>
						<TextControl
							label={ __( 'Field ID', 'layoutbridge-block-migration' ) }
						...
						/>
						<SelectControl
							label={ __( 'Field Type', 'layoutbridge-block-migration' ) }
							value={ formFields[ editingField ].fieldType }
							options={ [
								{
									label: __( 'Text', 'layoutbridge-block-migration' ),
									value: 'text',
								},
								{
									label: __(
								...
								{
									label: __( 'Tel', 'layoutbridge-block-migration' ),
									value: 'tel',
								},
								{
									label: __(
								...
								{
									label: __( 'URL', 'layoutbridge-block-migration' ),
									value: 'url',
								},
								{
									label: __(
						...
						/>
						<ToggleControl
							label={ __( 'Required', 'layoutbridge-block-migration' ) }
				...
				<PanelBody
					title={ __( 'Advanced', 'layoutbridge-block-migration' ) }
					initialOpen={ false }
				>
					<TextControl
