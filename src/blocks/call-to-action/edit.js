...
export default function Edit( { attributes, setAttributes } ) {
	...
	const contentStyle = {
		...
		padding: `${ contentPadding.top || 50 }px ${
			contentPadding.right || 50
		}px ${ contentPadding.bottom || 50 }px ${
			contentPadding.left || 50
		}px`,
			...
			<InspectorControls>
				...
				>
					<div className="components-base-control">
						...
						<Button
							onClick={ () =>
								setShowContentBgColor( ! showContentBgColor )
							}
							style={ {
								backgroundColor:
									contentBgColor || 'rgba(255,255,255,0.9)',
								width: '100%',
								justifyContent: 'center',
							} }
						>
							{ contentBgColor ||
								__( 'Choose Color', 'call-to-action-block' ) }
						</Button>
						{ showContentBgColor && (
							<Popover
				...
				>
					...
					<ToggleControl
						...
						onChange={ ( v ) =>
							setAttributes( { buttonNofollow: !! v } )
						}
					/>
					...
					<div className="components-base-control">
						...
						<Button
							onClick={ () =>
								setShowButtonBgColor( ! showButtonBgColor )
							}
							style={ {
					...
					<div className="components-base-control">
						...
						<Button
							onClick={ () =>
								setShowButtonTextColor( ! showButtonTextColor )
							}
							style={ {
					...
					<RangeControl
						...
						onChange={ ( v ) =>
							setAttributes( { buttonBorderRadius: v } )
						}
						min={ 0 }
						max={ 50 }
					/>
				...
				>
					...
					<SelectControl
						...
						onChange={ ( v ) =>
							setAttributes( { titleTextTransform: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { titleFontStyle: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { titleTextDecoration: v } )
						}
					/>
					<TextControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { titleLineHeight: v } )
						}
						help={ __(
							'E.g., 1.2 or 1.2em',
							'call-to-action-block'
					...
					<TextControl
						...
						onChange={ ( v ) =>
							setAttributes( { titleLetterSpacing: v } )
						}
						help={ __(
							'E.g., 2px or 0.1em',
							'call-to-action-block'
					...
					<TextControl
						...
						onChange={ ( v ) =>
							setAttributes( { titleWordSpacing: v } )
						}
						help={ __(
							'E.g., 5px or 0.2em',
							'call-to-action-block'
				...
				>
					<RangeControl
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionSize: v } )
						}
						min={ 8 }
						max={ 48 }
					/>
					<div className="components-base-control">
						...
						<Button
							onClick={ () =>
								setShowDescColor( ! showDescColor )
							}
							style={ {
					...
					<TextControl
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionFontFamily: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionFontWeight: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionTextTransform: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionFontStyle: v } )
						}
					/>
					<SelectControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionTextDecoration: v } )
						}
					/>
					<TextControl
						label={ __(
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionLineHeight: v } )
						}
						help={ __(
							'E.g., 1.4 or 1.4em',
							'call-to-action-block'
					...
					<TextControl
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionLetterSpacing: v } )
						}
						help={ __(
							'E.g., 1px or 0.05em',
							'call-to-action-block'
					...
					<TextControl
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionWordSpacing: v } )
						}
						help={ __(
							'E.g., 4px or 0.2em',
							'call-to-action-block'
					...
					<RangeControl
						...
						onChange={ ( v ) =>
							setAttributes( { descriptionSpacing: v } )
						}
						min={ 0 }
						max={ 100 }
					/>
					...
					{ ribbonTitle && (
						<>
							...
							<RangeControl
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonDistance: v } )
								}
								min={ 0 }
								max={ 100 }
							/>
							...
							<TextControl
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonFontFamily: v } )
								}
							/>
							<SelectControl
								label={ __(
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonFontWeight: v } )
								}
							/>
							<SelectControl
								label={ __(
									'Ribbon Text Transform',
									'call-to-action-block'
								) }
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonTextTransform: v } )
								}
							/>
							<SelectControl
								label={ __(
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonFontStyle: v } )
								}
							/>
							<SelectControl
								label={ __(
									'Ribbon Text Decoration',
									'call-to-action-block'
								) }
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonTextDecoration: v } )
								}
							/>
							<TextControl
								label={ __(
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonLineHeight: v } )
								}
								help={ __(
									'E.g., 1.5 or 1.5em',
									'call-to-action-block'
							...
							<TextControl
								label={ __(
									'Ribbon Letter Spacing',
									'call-to-action-block'
								) }
								value={ ribbonLetterSpacing }
								onChange={ ( v ) =>
									setAttributes( { ribbonLetterSpacing: v } )
								}
								help={ __(
									'E.g., 2px or 0.1em',
									'call-to-action-block'
							...
							<TextControl
								...
								onChange={ ( v ) =>
									setAttributes( { ribbonWordSpacing: v } )
								}
								help={ __(
									'E.g., 5px or 0.2em',
									'call-to-action-block'
					...
					{ ribbonTitle && (
						<div
							...
							style={ {
								...
								textDecoration:
									ribbonTextDecoration || undefined,
						...
						{ description || ! description ? (
							<RichText
								...
								style={ {
									...
									textTransform:
										descriptionTextTransform || undefined,
									fontStyle:
										descriptionFontStyle || undefined,
									textDecoration:
