...
export default function Edit( { attributes, setAttributes } ) {
	...
	const [ showHoverBgColorPicker, setShowHoverBgColorPicker ] =
		useState( false );
		...
		<>
			...
			<InspectorControls>
				...
				>
												...
												<div className="fontawesome-icon-grid">
													{ filteredIcons.map(
														( iconName ) => (
															...
															>
																<i
																	className={ `${ stylePrefix } ${ iconName }` }
																/>
															</Button>
														)
													) }
					...
					<div
						className="fontawesome-svg-upload"
				...
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'None', 'fontawesome-icon-block' ),
								value: 'none',
							},
							{
								label: __(
							...
							{
								label: __( 'Pulse', 'fontawesome-icon-block' ),
								value: 'pulse',
							},
						] }
					/>
					...
					<div className="components-base-control">
						...
						{ showHoverBgColorPicker && (
							<Popover
								position="bottom left"
								onClose={ () =>
									setShowHoverBgColorPicker( false )
								}
							>
								<ColorPicker
